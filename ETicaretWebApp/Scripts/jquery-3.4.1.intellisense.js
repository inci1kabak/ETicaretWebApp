intellisense.annotate(jQuery, {
  ...
  'browser.version': function() {
    /// <summary>The version number of the rendering engine for the ApplicationUser's browser. This property was removed in jQuery 1.9 and is available only through the jQuery.migrate plugin.</summary>
    /// <returns type="String" />
  },
  'Callbacks': function() {
    /// <signature>
